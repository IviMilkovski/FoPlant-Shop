...
if(isset($_GET["message"])){
 echo "<p class='alert alert-info col-8 mt-3 mxauto'>".$_GET["message"]."</p>";
 }
 ?>
</div>
<div class="container py-5">
        <div class="row py-5">
   <form action="models/doLogin.php" method="POST">
        ...
        <div class="form-group p-2 mb-3">
        <button type="submit" class="btn btn-outline-dark" name="btnLogin">Submit</button>
         </div>
    </form>
    <?php
 if(isset($_SESSION["error"])):
    echo "<p class='alert alert-danger col-9 mt-3 mxauto'>".$_SESSION["error"]." </p>";
